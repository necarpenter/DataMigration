...
DESC = """
# Welcome to the documentation for the DataMigration API layer!
...
FAKE_USERS_DB = {
    "necarpenter@gmail.com": {
        "full_name": "Nate Carpenter",
        "username": "necarpenter@gmail.com",
...
def main():
    ...
    uvicorn.run("api_datamigration:app", host='0.0.0.0', port=8000, reload=True)
